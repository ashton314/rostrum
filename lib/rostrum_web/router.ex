defmodule RostrumWeb.Router do
  ...
  scope "/", RostrumWeb do
    ...
    live "/meetings/from_template", MeetingLive.Index, :from_template
  ...
  scope "/", RostrumWeb do
    # require_role defaults to ":editor"
    pipe_through [:browser, :require_authenticated_user, :require_unit_user, :require_role]

    live "/templates/:id/show/event/new", TemplateLive.Show, :new_event
    live "/templates/:id/show/event/new/after/:after_event_id", TemplateLive.Show, :new_event
    live "/templates/:id/show/event/:event_id", TemplateLive.Show, :edit_event

    # autogenerated routes for templates
