defmodule RostrumWeb.UserAuth do
  use RostrumWeb, :verified_routes
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_rostrum_web_user_remember_me"
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      RostrumWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the current_user:
      ...
      defmodule RostrumWeb.PageLive do
        use RostrumWeb, :live_view

        on_mount {RostrumWeb.UserAuth, :mount_current_user}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{RostrumWeb.UserAuth, :ensure_authenticated}] do
